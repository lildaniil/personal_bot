...
Step 1: extract texts
    ...
    # pybabel extract --input-dirs=loc.py -o utils/locales/mybot.pot
...
Step 2: create *.po files. E.g. create en, ru, uk locales.
    ...
    # pybabel init -i utils/locales/mybot.pot -d utils/locales -D mybot -l en

    # pybabel init -i utils/locales/mybot.pot -d utils/locales -D mybot -l ru

    # pybabel init -i utils/locales/mybot.pot -d utils/locales -D mybot -l uk
...
TOKEN = '5651088973:AAEfLgt97DAzTVnlCPKhUl3pCatKZp3qeM8'
